...
\section{Objectifs}
	...
	\begin{itemize}
		\item d'un microcontrôleur (PIC 18f458) qui recevra des input, les traitera, et enverra les réponses sur les outputs adéquats
	...
	\end{itemize}
	L'état de la carte sera interfacée à l'aide d'une application Java, et le PIC sera programmé en C.	
...
\section{Cahier des charges}
	...
	\begin{itemize}
		...
		\item d'écouter l'interface Java via un port particulier et de réagir en conséquences
	\end{itemize}	
...
\section{Dessin de la carte}
			\includegraphics[scale=0.4]{schemaElec.png}
